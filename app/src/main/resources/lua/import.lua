...
local LuaAsyncTask = luajava.bindClass("com.aslua.LuaAsyncTask")
local LuaThread = luajava.bindClass("com.aslua.LuaThread")
local LuaTimer = luajava.bindClass("com.aslua.LuaTimer")
